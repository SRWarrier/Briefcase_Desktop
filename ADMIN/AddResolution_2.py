...
class Ui(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.NarrationInput = KeyWordCompletor.KeywordComplete(QtWidgets.QTextEdit(self.widget))
        font = QtGui.QFont()
    ...
    def addRes(self):
        ...
        NARRATION = self.NarrationInput.toPlainText()
        TITLE = self.TitleInput.text()
        RESOLUTION = self.ResolutionInput.toPlainText()
        VaraibleTableValues=[]
        ...
        ResolutionDict = {'DESCRIPTION':DESCRIPTION,'TITLE':TITLE,'SUMMARY':SUMMARY,'NARRATION':NARRATION,'RESOLUTION':RESOLUTION,'FIELDS':jsonedFields}
    ...
    def AddVariableField(self):
        ...
        self.combo_box_options = sorted(["1.Text Input","2.Date Input",'3.Time Input','4.DIN Input','DIN Prefill Name','DIN Prefill Fathers Name',
                             'DIN Prefill Address','DIN Prefill Email','DIN Prefill DOA','DIN Prefill PAN','DIN Prefill Title',
                             'CIN Prefill Company Name','5.CIN Input','CIN Prefill Registered OFfice','CIN Prefill Authorised Capital',
                             'CIN Prefill Paidup Capital','CIN Prefill ROC','CIN Prefill DOI','6.Charge ID Input',
                             'Charge Prefill Charge Holder Name','Charge Prefill Charge Holder Address','Charge Prefill Amount'
                             'Charge Prefill Creation Date','Charge Prefill Modification Date','Charge Prefill Satisfaction Date'])
